...
def callback():
    ...
    try:
        ...
        is_professor = email.endswith(f'@{dominio_professori}')  # FIX: era is_professore
        ...
        if user:
            ...
            user.is_professor = is_professor  # FIX: era is_professore
        else:
            # Crea nuovo utente
            user = User(
                google_id=google_id,
                ...
                cognome=cognome,
                picture=picture,
                is_professor=is_professor  # FIX: era is_professore
            )
            db.session.add(user)
        ...
        tipo = "professore" if is_professor else "studente"
...
def profile():
    ...
    info = {
        ...
        'Tipo': 'Professore' if current_user.is_professor else 'Studente',
        'ID': current_user.id,
